...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CarFeaturesController : ControllerBase
    {
        ...
        public async Task<IActionResult> ChangeAvaiblableToTrue(int id)
        {
            _mediator.Send(new UpdateCarFeatureAvailableChangeToTrueCommand(id));
            return Ok("Car Feature Available Changed to True.");
        }
        [HttpGet("CarFeatureChangeAvailableToFalse")]
        public async Task<IActionResult> ChangeAvaiblableToFalse(int id)
        {
            _mediator.Send(new UpdateCarFeatureAvailableChangeToFalseCommand(id));
            return Ok("Car Feature Available Changed to False.");
        }
